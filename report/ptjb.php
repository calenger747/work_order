<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    <div class="x_title">
      <h2>Report PTJB <small>Laporan PTJB</small></h2>
    ...
    <div class="x_content">
      <form class="form-horizontal" action="report/excel-ptjb.php" method="post"  role="form">
        <div class="panel panel-primary setup-content">
          <div class="panel-heading">
          <h3 class="panel-title">Lihat PTJB per-Bulan</h3>
          </div>
