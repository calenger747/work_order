  ...
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <?php 
          ...
          $cekdulu = "SELECT * FROM tbl_project_wo JOIN tbl_teknisi_wo ON tbl_project_wo.kode_teknisi = tbl_teknisi_wo.kode_teknisi WHERE tbl_teknisi_wo.teknisi1 = '$p_nama' OR tbl_teknisi_wo.teknisi2 = '$p_nama' OR tbl_teknisi_wo.teknisi3 = '$p_nama' OR tbl_teknisi_wo.teknisi4 = '$p_nama' OR tbl_teknisi_wo.pkl1 = '$p_nama' OR tbl_teknisi_wo.pkl2 = '$p_nama' OR tbl_teknisi_wo.pkl3 = '$p_nama'"; 
      ...
      <div class="container">
        <div class="stepwizard">
          ...
          <h3><b>Nama Teknisi : <?php echo $p_nama; ?></b></h3><hr>
          ...
          <div class="x_content">
                ...
                <thead>
                  <tr>
                    <th colspan="5"><h3>Total Amount : </h3></th>
                    <th colspan="2"><h4><?php echo $rp, number_format($amount_price, 0, ".", "."); ?></h3></th>
                  </tr>
                </thead>
              </table>
            </div>
