<?php
  ...
  if ($id == "") {
    ...
    $nav         = "Update Project";
    $ambil       = "project/teknisi/update-project.php";
    $class       = "active";
    ...
    $nav         = "Add Project";
    $ambil       = "project/teknisi/add-project.php";
    $class       = "active";
    ...
    $nav         = "Project List";
    $ambil       = "project/teknisi/project-data.php";
    $class       = "active";
    ...
    $nav         = "Detail Project";
    $ambil       = "project/teknisi/view-detail.php";
    $class       = "active";
    $ambilcss1   = "vendors/datatables.net-bs/css/dataTables.bootstrap.min.css";
    $ambilcss2   = "vendors/datatables.net-buttons-bs/css/buttons.bootstrap.min.css";
    $ambilcss3   = "vendors/datatables.net-fixedheader-bs/css/fixedHeader.bootstrap.min.css";
  ...
  <body class="nav-md">
    ...
    <script type="text/javascript">
        ...
        $('#wo').autocomplete({
          ...
          source: 'search/search-wo-teknisi.php', //file untuk mencari data mahasiswa
