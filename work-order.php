<?php
  ...
  if ($id == "") {
    ...
    $nav         = "Income WO";
    $ambil       = "finance/income/incomeWO.php";
    $class       = "active";
    $ambilcss1   = "vendors/datatables.net-bs/css/dataTables.bootstrap.min.css";
    $ambilcss2   = "vendors/datatables.net-buttons-bs/css/buttons.bootstrap.min.css";
    $ambilcss3   = "vendors/datatables.net-fixedheader-bs/css/fixedHeader.bootstrap.min.css";
    ...
    $ambiljs21    = "js/datatables.min.js";
    $ambiljs3    = "vendors/bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js";
} elseif ($id == "income-by-ba") {
    $nav         = "Income BA";
    $ambil       = "finance/income/incomeBA.php";
    $class       = "active";
    $ambilcss1   = "vendors/datatables.net-bs/css/dataTables.bootstrap.min.css";
    $ambilcss2   = "vendors/datatables.net-buttons-bs/css/buttons.bootstrap.min.css";
    $ambilcss3   = "vendors/datatables.net-fixedheader-bs/css/fixedHeader.bootstrap.min.css";
...
<body class="nav-md">
        ...
        <div class="main_container">
                                    ...
                                    <ul class="nav child_menu">
                                        <li class=""><a>Excel<span class="fa fa-chevron-down"></span></a>
                                            <ul class="nav child_menu">
                                                ...
                                                <li><a href="?id=incomeWO&mod=search">Income By WO</a></li>
                                                <li><a href="?id=income-by-ba&mod=search">Income By BA</a></li>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <?php echo $_SESSION['namauser']; ?> &nbsp
            ...
            <footer>
                <div style="text-align: center;">
                    <p>&copy;
                        <?php echo $year = date("Y"); ?> PT. Lumbung Riang Communication | All Right Reserved </p>
                </div>
                <div class="clearfix"></div>
            </footer>
            <!-- /footer content -->
    ...
    $(document).ready(function() {
        $('#ba-ex').autocomplete({
            minLength: 1, //minimal huruf saat autocomplete di proses
            source: 'search/search-ba-ex.php', //file untuk mencari data mahasiswa
            select: function(event, ui) {
                $('#ba').val(ui.item.ba);
            }
        })
