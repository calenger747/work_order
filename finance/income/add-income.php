<?php 
  ...
  $p_notes     = isset($_POST['notes']) ? $_POST['notes'] : ""; 
  ...
  if (mysqli_num_rows($prosescek) > 0) { 
    ...
    $q_edt2  = mysqli_query($con, "UPDATE tbl_income_detail SET verifikasi = '$p_verifikasi', no_pb = '$p_nopb', pb_date = '$p_pbdate', handover = '$p_handover', po_no = '$p_pono', po_date = '$p_podate', req_gr = '$p_reqgr', inv_no = '$p_invno', pay_stat = '$p_pay', pay_date = '$p_paydate', final_stat = '$p_final', notes = '$p_notes' WHERE kd_detail = '$p_kd_detail'");
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content"> 
                      ...
                      <form class="form-horizontal" action="?id=add-income&mod=Tambah" method="post" role="form">
                          <div class="panel panel-primary setup-content">
                              <div class="panel-heading">
                                   <h3 class="panel-title">Input Income</h3>
                              </div>
                              <div class="panel-body">
                                  <div class="form-group">
                                    <div class="col-sm-6">
                                      <label for="wo">Input WO ID</label>
                                        <input type="text" name="wo" value="<?php echo $id_wo; ?>" class="form-control" id="wo" readonly>
                                    </div>
                                    <div class="col-sm-6">
                                      <label for="so">Input SO ID</label>
                                        <input type="text" name="so" value="<?php echo $id_so; ?>" class="form-control" id="so" readonly>
                                    </div>
                                  </div>
                                  <hr>
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                      <label for="so">NO BOQ</label>
                                        <input type="text" name="boq" class="form-control">
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <div class="col-sm-4">
                                      ...
                                      <div class='input-group date' id='datepicker'>
                                        ...
                                        <input type='text' class="form-control" name="tglba" placeholder="YYYY/MM/DD" required />
                                      </div>
                                    </div>
                                    <div class="col-sm-4">
                                      <label class="control-label">PM</label>
                                      <input name="pm" type="text" value="<?php echo $pic; ?>" id="pm" required="required" class="form-control" readonly/>
                                    </div>
                                    <div class="col-sm-4">
                        ...
                        <form class="form-horizontal" action="?id=add-income&mod=edit" method="post"  role="form">
                          ...
                          <div class="panel panel-primary setup-content">
                              ...
                              <div class="panel-body">
                                  ...
                                  <div class="form-group">
                                    <label>NOTES</label>
                                    <textarea name="notes" class="form-control" rows="4"><?php echo $e_notes; ?></textarea>
                                  </div>
                                  <br><br>
                                  <input type="submit" name="kirim_daftar" class="btn btn-primary pull-right" value="<?php echo $p_submit; ?>">
                                  <a href="?id=income"><button type="button" class="btn btn-warning pull-left"><span class="fa fa-arrow-left"> Back</span></button></a>
