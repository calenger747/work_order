...
<div class="col-md-12 col-sm-12 col-xs-12">
  <div class="x_panel">
    <div class="x_title">
      <h2>Income by BA  <small>Laporan Income </small></h2>
    ...
    <div class="x_content">
      ...
      ?>
      <form class="form-horizontal" action="?id=income-by-ba&mod=view" method="post"  role="form">
        <input type="hidden" name="id_daftar" value="<?php echo $id_daftar; ?>">
        <div class="panel panel-primary setup-content">
          <div class="panel-heading">
            <h3 class="panel-title">Search by BA</h3>
          </div>
          <div class="panel-body">
            <div class="form-group">
              <div class="col-xs-24 col-lg-12">
                <label for="no_ba">NOMOR BA</label>
                <input type="text" name="ba" class="form-control" id="ba" ><br/>
            </div>
            <div class="form-group">
              <br/>
      ...
      ?>                      
                        ...
                        <h3><b>NO. BA : <?php echo $ba; ?></b></h3>
                         <form class="form-horizontal" action="report/excel-income-ba.php?ba=<?= $ba ?>" method="post"  role="form">
                          <input type="hidden" name="no_ba" value="<?= $ba ?>">
